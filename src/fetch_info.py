...
def fetch_info(
    ...
    print('*'*25 + exp_name +' fetch start' + '*'*25)
    best_model_path = "analysis/multi_intere/model/" + exp_name + '/'
    ...
    model = Model_Mine(item_count, args.embedding_dim, args.hidden_size, batch_size, 
                       ...
                       args.f_encoder, args.sa_dim, args.f_trans)
    ...
    write_file = "analysis/multi_intere/info/"+exp_name+'_info.txt'
...
if __name__ == '__main__':
    ...
    fetch_info(test_file=test_file, cate_file=cate_file, item_count=item_count, 
               ...
               model_type=args.model_type, lr=args.learning_rate, exp_name=exp_name)
